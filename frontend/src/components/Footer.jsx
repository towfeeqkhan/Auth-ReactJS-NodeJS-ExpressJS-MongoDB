const Footer = () => {
  return (
    <>
      ...
      <footer className="flex flex-col bg-[#1A0033] items-center justify-around w-full py-16 text-sm text-white">
        ...
        <p className="mt-8 text-center text-gray-500">Copyright © 2026</p>
      </footer>
    </>
  );
};
